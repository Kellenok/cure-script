...
<details> <summary> Just one of my rambling notes about the technicalities of terminology  </summary>
...
**Now, this kind of に can only be used when we are projecting something, whether it's**
...
<details>
  <summary>VERY optional <code>Explanation</code> Note & example of my chronic rambling (or whatever lol)</summary>
