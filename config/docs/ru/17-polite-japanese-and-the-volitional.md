...
**Вспомогательный глагол волитива для годан-глаголов,** как и вспомогательный глагол потенциала — вспомогательный глагол потенциала — это просто одна кана, る(-ru), а **вспомогательный глагол волитива — это просто одна кана う**(-u), **и мы добавляем её к концу お-основы, и она удлиняет звук お.** Так, <code>話す</code> становится <code>話そう</code>, <code>歩く</code> становится <code>歩こう</code> и так далее.
