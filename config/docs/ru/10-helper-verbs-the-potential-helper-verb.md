...
И **это интересное слово, потому что оно также означает <code>выходить</code>** — буквально оно состоит из кандзи <code>выход</code> и <code>приходить</code> — <code>[出]{で}きる</code>, 出る (выходить) 来る (приходить)
