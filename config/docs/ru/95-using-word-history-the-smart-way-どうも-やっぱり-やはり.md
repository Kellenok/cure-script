...
Опять же, **другой человек сказал, что он пошёл, и мы подчёркиваем <code>も</code>, говоря <code>やはり</code>**, **возвращаясь к первоначальному фокусу этой части разговора, к тому факту, что вы пошли:** «Ну, **やはり** — **первоначальный фокус** — я **тоже** пошёл».
