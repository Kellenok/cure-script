...
Что бы мы ни сказали, за этим следует какая-то отрицательная конструкция, и то, что мы говорим, это <code>Я должен идти / Мне нужно идти / Я должен сделать это / Я должен сделать то</code>, и это потому, что у нас нет такой конструкции <code>нужно</code> и у нас нет <code>должен</code> в японском языке. Она всегда имеет эту довольно многословную форму «Если я не сделаю, это не будет хорошо / если я не сделаю, это не годится / Если я не сделаю, это плохо» — <code>[無]{な}ければダメ</code>.
